    ...
    <main className="max-w-[1200px] mx-auto px-container-margin py-xxl">
      ...
      <section className="text-center max-w-2xl mx-auto mb-xl reveal">
        ...
        <p className="font-body-md text-body-md text-on-surface-variant mb-lg">
          Eksplorasi ribuan resep bernutrisi yang telah dikurasi secara ilmiah untuk memenuhi Angka Kecukupan Gizi (AKG) harian Anda. Temukan inspirasi masakan sehat dengan mudah.
        </p>
        {/* Search Bar */}
